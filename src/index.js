...
export { HeadingNumbering } from './extensions/headingNumbering.js'
export { PageView } from './extensions/pageView.js'
export { ParagraphSpacing } from './extensions/paragraphSpacing.js'
export { VectorIllustration, VECTOR_ILLUSTRATION_NAME } from './extensions/vectorIllustration.js'
export { sanitizeSvg, rasterizeSvg, VECTOR_ATTR } from './extensions/vectorSvg.js'
export { computeHeadingNumbers, headingNumbersFor } from './extensions/headingNumbers.js'
